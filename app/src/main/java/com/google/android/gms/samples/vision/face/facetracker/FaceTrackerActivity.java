...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        s3Client =  new AmazonS3Client(new BasicAWSCredentials(S3_ACCESS_KEY, S3_SECRETKEY));
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onNewItem(int faceId, Face item) {
            ...
            float leftEye = item.getIsLeftEyeOpenProbability();
            float rightEye = item.getIsRightEyeOpenProbability();
            if (leftEye > 0.6 && rightEye > 0.4) {
    ...
    private void sendData(final byte[] bytes){
        asyncTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
              ...
              FileUtils.uploadToS3("PHOTO/" + md5(timestamp),bytes,s3Client);
                return null;
            }
        };
